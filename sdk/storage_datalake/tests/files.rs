...
async fn file_create_delete() -> azure_core::Result<()> {
    setup::run_with_each_response_variant(
        "datalake_file_create_delete",
        |data_lake_client| async move {
...
async fn file_read() -> azure_core::Result<()> {
    setup::run_with_each_response_variant("datalake_file_read", |data_lake_client| async move {
...
async fn file_upload() -> azure_core::Result<()> {
    setup::run_with_each_response_variant("datalake_file_upload", |data_lake_client| async move {
...
async fn file_rename() -> azure_core::Result<()> {
    setup::run_with_each_response_variant("datalake_file_rename", |data_lake_client| async move {
